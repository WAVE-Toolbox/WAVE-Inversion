...
KITGPI::Gradient::ViscoSH<ValueType>::ViscoSH(scai::hmemo::ContextPtr ctx, scai::dmemo::DistributionPtr dist)
{
 ...
 */
template <typename ValueType>
void KITGPI::Gradient::ViscoSH<ValueType>::init(scai::hmemo::ContextPtr ctx, scai::dmemo::DistributionPtr dist)
{
    init(ctx, dist, 0.0, 0.0);
}
 ...
 */
template <typename ValueType>
void KITGPI::Gradient::ViscoSH<ValueType>::init(scai::hmemo::ContextPtr ctx, scai::dmemo::DistributionPtr dist, ValueType velocityS_const, ValueType rho_const)
{
...
template <typename ValueType>
KITGPI::Gradient::ViscoSH<ValueType>::ViscoSH(const ViscoSH &rhs)
{
...
*/
template <typename ValueType>
void KITGPI::Gradient::ViscoSH<ValueType>::resetGradient()
{
 ...
 */
template <typename ValueType>
void KITGPI::Gradient::ViscoSH<ValueType>::write(std::string filename, IndexType fileFormat, KITGPI::Workflow::Workflow<ValueType> const &workflow) const
{
 ...
 */
template <typename ValueType>
std::string KITGPI::Gradient::ViscoSH<ValueType>::getEquationType() const
{
    return (equationType);
}
 ...
 */
template <typename ValueType>
scai::lama::Vector<ValueType> const &KITGPI::Gradient::ViscoSH<ValueType>::getVelocityP()
{
    COMMON_THROWEXCEPTION("There is no velocityP in an viscosh modelling")
    return (velocityP);
}
 ...
 */
template <typename ValueType>
scai::lama::Vector<ValueType> const &KITGPI::Gradient::ViscoSH<ValueType>::getTauP()
{
    COMMON_THROWEXCEPTION("There is no tau parameter in an viscosh modelling")
    return (tauP);
}
 ...
 */
template <typename ValueType>
scai::lama::Vector<ValueType> const &KITGPI::Gradient::ViscoSH<ValueType>::getTauS()
{
    COMMON_THROWEXCEPTION("There is no tau parameter in an viscosh modelling")
    return (tauS);
}
...
template <typename ValueType>
ValueType KITGPI::Gradient::ViscoSH<ValueType>::getRelaxationFrequency() const
{
    COMMON_THROWEXCEPTION("There is no relaxationFrequency parameter in an viscosh modelling")
    return (relaxationFrequency);
}

/*! \brief Getter method for number of relaxation mechanisms */
template <typename ValueType>
IndexType KITGPI::Gradient::ViscoSH<ValueType>::getNumRelaxationMechanisms() const
{
    COMMON_THROWEXCEPTION("There is no numRelaxationMechanisms parameter in an viscosh modelling")
 ...
 */
template <typename ValueType>
KITGPI::Gradient::ViscoSH<ValueType> KITGPI::Gradient::ViscoSH<ValueType>::operator*(ValueType rhs)
{
    KITGPI::Gradient::ViscoSH<ValueType> result(*this);
    result *= rhs;
    return result;
}
 ...
 */
template <typename ValueType>
KITGPI::Gradient::ViscoSH<ValueType> operator*(ValueType lhs, KITGPI::Gradient::ViscoSH<ValueType> rhs)
{
    return rhs * lhs;
}
 ...
 */
template <typename ValueType>
KITGPI::Gradient::ViscoSH<ValueType> &KITGPI::Gradient::ViscoSH<ValueType>::operator*=(ValueType const &rhs)
{
 ...
 */
template <typename ValueType>
KITGPI::Gradient::ViscoSH<ValueType> KITGPI::Gradient::ViscoSH<ValueType>::operator+(KITGPI::Gradient::ViscoSH<ValueType> const &rhs)
{
    KITGPI::Gradient::ViscoSH<ValueType> result(*this);
    result += rhs;
    return result;
 ...
 */
template <typename ValueType>
void KITGPI::Gradient::ViscoSH<ValueType>::assign(KITGPI::Gradient::Gradient<ValueType> const &rhs)
{
 ...
 */
template <typename ValueType>
void KITGPI::Gradient::ViscoSH<ValueType>::minusAssign(KITGPI::Gradient::Gradient<ValueType> const &rhs)
{
    density -= rhs.getDensity();
    velocityS -= rhs.getVelocityS();
    porosity -= rhs.getPorosity();
 ...
 */
template <typename ValueType>
void KITGPI::Gradient::ViscoSH<ValueType>::plusAssign(KITGPI::Gradient::Gradient<ValueType> const &rhs)
{
    density += rhs.getDensity();
    velocityS += rhs.getVelocityS();
    porosity += rhs.getPorosity();
 ...
 */
template <typename ValueType>
void KITGPI::Gradient::ViscoSH<ValueType>::timesAssign(ValueType const &rhs)
{
    if (workflowInner.getInvertForDensity()) 
        density *= rhs;
    if (workflowInner.getInvertForVs()) 
 ...
 */
template <typename ValueType>
void KITGPI::Gradient::ViscoSH<ValueType>::timesAssign(scai::lama::Vector<ValueType> const &rhs)
{
    density *= rhs;
    velocityS *= rhs;
    porosity *= rhs;
 ...
 */
template <typename ValueType>
void KITGPI::Gradient::ViscoSH<ValueType>::minusAssign(KITGPI::Modelparameter::Modelparameter<ValueType> &lhs, KITGPI::Gradient::Gradient<ValueType> const &rhs)
{
 ...
 */
template <typename ValueType>
void KITGPI::Gradient::ViscoSH<ValueType>::sumShotDomain(scai::dmemo::CommunicatorPtr commInterShot)
{
 ...
 */
template <typename ValueType>
void KITGPI::Gradient::ViscoSH<ValueType>::sumGradientPerShot(KITGPI::Modelparameter::Modelparameter<ValueType> &model, KITGPI::Gradient::Gradient<ValueType> &gradientPerShot, Acquisition::Coordinates<ValueType> const &modelCoordinates, Acquisition::Coordinates<ValueType> const &modelCoordinatesBig, Acquisition::coordinate3D cutCoordinate)
{
...
*/
template <typename ValueType>
void KITGPI::Gradient::ViscoSH<ValueType>::smooth(scai::dmemo::CommunicatorPtr commAll, KITGPI::Configuration::Configuration config)
{
...
*/
template <typename ValueType>
void KITGPI::Gradient::ViscoSH<ValueType>::applyMedianFilter(scai::dmemo::CommunicatorPtr commAll, KITGPI::Configuration::Configuration config)
{
    if (config.get<IndexType>("NZ") == 1) {
        scai::IndexType NY = config.get<IndexType>("NY");
        scai::IndexType NX = porosity.size() / NY; // NX is different in stream configuration
 ...
 */
template <typename ValueType>
void KITGPI::Gradient::ViscoSH<ValueType>::scale(KITGPI::Modelparameter::Modelparameter<ValueType> const &model, KITGPI::Workflow::Workflow<ValueType> const &workflow, KITGPI::Configuration::Configuration config)
{    
 ...
 */
template <typename ValueType>
void KITGPI::Gradient::ViscoSH<ValueType>::applyEnergyPreconditioning(ValueType epsilonHessian, scai::IndexType saveApproxHessian, std::string filename, scai::IndexType fileFormat)
{
 ...
 */
template <typename ValueType>
void KITGPI::Gradient::ViscoSH<ValueType>::normalize()
{
 ...
 */
template <typename ValueType>
void KITGPI::Gradient::ViscoSH<ValueType>::estimateParameter(KITGPI::ZeroLagXcorr::ZeroLagXcorr<ValueType> const &correlatedWavefields, KITGPI::Modelparameter::Modelparameter<ValueType> const &model, ValueType DT, KITGPI::Workflow::Workflow<ValueType> const &workflow)
{
 ...
 */
template <typename ValueType>
void KITGPI::Gradient::ViscoSH<ValueType>::calcModelDerivative(KITGPI::Misfit::Misfit<ValueType> &dataMisfit, KITGPI::Modelparameter::Modelparameter<ValueType> const &model, KITGPI::ForwardSolver::Derivatives::Derivatives<ValueType> const &derivativesEM, KITGPI::Configuration::Configuration configEM, KITGPI::Taper::Taper2D<ValueType> modelTaper2DJoint, KITGPI::Workflow::Workflow<ValueType> const &workflow)
{
    ...
    velocityStemp.allocate(distEM);
    modelTaper2DJoint.applyGradientTransform1to2(model.getDensity(), densitytemp);
    modelTaper2DJoint.applyGradientTransform1to2(model.getVelocityS(), velocityStemp); 
 ...
 */
template <typename ValueType>
void KITGPI::Gradient::ViscoSH<ValueType>::calcCrossGradient(KITGPI::Misfit::Misfit<ValueType> &dataMisfitEM, KITGPI::Modelparameter::Modelparameter<ValueType> const &model, KITGPI::ForwardSolver::Derivatives::Derivatives<ValueType> const &derivativesEM, KITGPI::Configuration::Configuration configEM, KITGPI::Taper::Taper2D<ValueType> modelTaper2DJoint, KITGPI::Workflow::Workflow<ValueType> const &workflow)
{
    scai::lama::DenseVector<ValueType> densitytemp;
    scai::lama::DenseVector<ValueType> velocityStemp;
    scai::lama::DenseVector<ValueType> modelDerivativeXtemp;
    ...
    if (workflow.getInvertForVs() && exchangeStrategy != 0) {  
        ...
        modelTaper2DJoint.applyGradientTransform2to1(velocityS, velocityStemp);  
    } else {
        this->initParameterisation(velocityS, ctx, dist, 0.0);
    }       
 ...
 */
template <typename ValueType>
void KITGPI::Gradient::ViscoSH<ValueType>::calcCrossGradientDerivative(KITGPI::Misfit::Misfit<ValueType> &dataMisfitEM, KITGPI::Modelparameter::Modelparameter<ValueType> const &model, KITGPI::ForwardSolver::Derivatives::Derivatives<ValueType> const &derivativesEM, KITGPI::Configuration::Configuration configEM, KITGPI::Taper::Taper2D<ValueType> modelTaper2DJoint, KITGPI::Workflow::Workflow<ValueType> const &workflow)
{
    scai::lama::DenseVector<ValueType> densitytemp;
    scai::lama::DenseVector<ValueType> velocityStemp;
    scai::lama::DenseVector<ValueType> modelDerivativeXtemp;
    ...
    if (workflow.getInvertForVs() && exchangeStrategy != 0) {    
        modelTaper2DJoint.applyGradientTransform1to2(velocityS, velocityStemp);          
 ...
 */
template <typename ValueType>
ValueType KITGPI::Gradient::ViscoSH<ValueType>::calcCrossGradientMisfit()
{
 ...
 */
template <typename ValueType>
void KITGPI::Gradient::ViscoSH<ValueType>::calcStabilizingFunctionalGradient(KITGPI::Modelparameter::Modelparameter<ValueType> const &model, KITGPI::Modelparameter::Modelparameter<ValueType> const &modelPriori, KITGPI::Configuration::Configuration config, KITGPI::Misfit::Misfit<ValueType> &dataMisfit, KITGPI::Workflow::Workflow<ValueType> const &workflow)
{    
...
template class KITGPI::Gradient::ViscoSH<float>;
template class KITGPI::Gradient::ViscoSH<double>;
