    ...
    namespace Gradient
    {
        ...
        class Acoustic : public GradientSeismic<ValueType>
        {
          public:
            ...
            void calcGaussianKernel(scai::dmemo::CommunicatorPtr commAll, KITGPI::Modelparameter::Modelparameter<ValueType> &model, KITGPI::Acquisition::Coordinates<ValueType> const &modelCoordinates, ValueType FCmax) override;
