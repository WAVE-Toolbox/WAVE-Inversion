...
namespace KITGPI
{
    ...
    namespace Gradient
    {
        ...
        /*! \brief Class to store the gradients for viscosh inversion
         *
         */
        template <typename ValueType>
        class ViscoSH : public GradientSeismic<ValueType>
        {
          public:
            //! Default constructor.
            ...
            explicit ViscoSH(scai::hmemo::ContextPtr ctx, scai::dmemo::DistributionPtr dist);
            ...
            KITGPI::Gradient::ViscoSH<ValueType> operator*(ValueType rhs);
            KITGPI::Gradient::ViscoSH<ValueType> &operator*=(ValueType const &rhs);
            KITGPI::Gradient::ViscoSH<ValueType> operator+(KITGPI::Gradient::ViscoSH<ValueType> const &rhs);
            KITGPI::Gradient::ViscoSH<ValueType> &operator+=(KITGPI::Gradient::ViscoSH<ValueType> const &rhs);
            KITGPI::Gradient::ViscoSH<ValueType> operator-(KITGPI::Gradient::ViscoSH<ValueType> const &rhs);
            KITGPI::Gradient::ViscoSH<ValueType> &operator-=(KITGPI::Gradient::ViscoSH<ValueType> const &rhs);
            KITGPI::Gradient::ViscoSH<ValueType> &operator=(KITGPI::Gradient::ViscoSH<ValueType> const &rhs);
