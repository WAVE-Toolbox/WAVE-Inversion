...
namespace KITGPI
{
    ...
    namespace ZeroLagXcorr
    {
        ...
        /*! \brief Class to hold and calculate the zero lag cross correlated wavefieldsEM for 2Dviscotmemgradients
         *
         */
        ...
        class ZeroLagXcorr2Dviscotmem : public ZeroLagXcorrEM<ValueType>
        {
          ...
          public:
            //! Default constructor
            ZeroLagXcorr2Dviscotmem(){equationTypeEM="viscotmem"; numDimension=2;};

            //! Default destructor
            ~ZeroLagXcorr2Dviscotmem(){};

            explicit ZeroLagXcorr2Dviscotmem(scai::hmemo::ContextPtr ctx, scai::dmemo::DistributionPtr distEM, KITGPI::Workflow::WorkflowEM<ValueType> const &workflowEM);
