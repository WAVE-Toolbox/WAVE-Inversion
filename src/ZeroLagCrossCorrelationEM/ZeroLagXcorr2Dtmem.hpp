...
namespace KITGPI
{
    ...
    namespace ZeroLagXcorr
    {
        ...
        /*! \brief Class to hold and calculate the zero lag cross correlated wavefieldsEM for 2Dtmemgradients
         *
         */
        ...
        class ZeroLagXcorr2Dtmem : public ZeroLagXcorrEM<ValueType>
        {
          ...
          public:
            //! Default constructor
            ZeroLagXcorr2Dtmem(){equationTypeEM="tmem"; numDimension=2;};

            //! Default destructor
            ~ZeroLagXcorr2Dtmem(){};

            explicit ZeroLagXcorr2Dtmem(scai::hmemo::ContextPtr ctx, scai::dmemo::DistributionPtr distEM, KITGPI::Workflow::WorkflowEM<ValueType> const &workflowEM);
