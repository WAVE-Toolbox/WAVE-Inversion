    ...
    namespace ZeroLagXcorr
    {
        ...
        class ZeroLagXcorr2Dviscoemem : public ZeroLagXcorrEM<ValueType>
        {
          ...
          public:
            ...
            explicit ZeroLagXcorr2Dviscoemem(scai::hmemo::ContextPtr ctx, scai::dmemo::DistributionPtr dist, KITGPI::Workflow::Workflow<ValueType> const &workflow, KITGPI::Configuration::Configuration config, scai::IndexType numShotPerSuperShot);
