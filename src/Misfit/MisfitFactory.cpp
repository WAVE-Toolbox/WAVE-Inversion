...
typename KITGPI::Misfit::Misfit<ValueType>::MisfitPtr KITGPI::Misfit::Factory<ValueType>::Create(std::string type)
{
    ...
    SCAI_ASSERT_ERROR(type.compare("l2") == 0 || type.compare("l5") == 0 || type.compare("l6") == 0 || type.compare("l7") == 0 || type.compare("l8") == 0 || type.compare("l9") == 0 || type.length() > 2, "Unknown type");

    if (type.compare("l2") == 0 || type.compare("l5") == 0 || type.compare("l6") == 0 || type.compare("l7") == 0 || type.compare("l8") == 0 || type.compare("l9") == 0 || type.length() > 2) {
