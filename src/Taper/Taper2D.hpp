    ...
    namespace Taper
    {
        ...
        class Taper2D
        {
          ...
          public:
            ...
            void calcTransformMatrix(KITGPI::Acquisition::Coordinates<ValueType> modelCoordinates2, KITGPI::Acquisition::Coordinates<ValueType> modelCoordinates1, IndexType equationInd);
