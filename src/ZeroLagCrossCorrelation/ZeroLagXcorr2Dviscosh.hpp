    ...
    namespace ZeroLagXcorr
    {
        ...
        class ZeroLagXcorr2Dviscosh : public ZeroLagXcorrSeismic<ValueType>
        {
          ...
          public:
            ...
            explicit ZeroLagXcorr2Dviscosh(scai::hmemo::ContextPtr ctx, scai::dmemo::DistributionPtr dist, KITGPI::Workflow::Workflow<ValueType> const &workflow, KITGPI::Configuration::Configuration config, scai::IndexType numShotPerSuperShot);
