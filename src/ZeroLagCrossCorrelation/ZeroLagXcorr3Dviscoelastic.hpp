    ...
    namespace ZeroLagXcorr
    {
        ...
        class ZeroLagXcorr3Dviscoelastic : public ZeroLagXcorrSeismic<ValueType>
        {
          ...
          public:
            ...
            explicit ZeroLagXcorr3Dviscoelastic(scai::hmemo::ContextPtr ctx, scai::dmemo::DistributionPtr dist, KITGPI::Workflow::Workflow<ValueType> const &workflow, KITGPI::Configuration::Configuration config);
