    ...
    namespace ZeroLagXcorr
    {
        ...
        class ZeroLagXcorr3Delastic : public ZeroLagXcorrSeismic<ValueType>
        {
          ...
          public:
            ...
            explicit ZeroLagXcorr3Delastic(scai::hmemo::ContextPtr ctx, scai::dmemo::DistributionPtr dist, KITGPI::Workflow::Workflow<ValueType> const &workflow, KITGPI::Configuration::Configuration config);
