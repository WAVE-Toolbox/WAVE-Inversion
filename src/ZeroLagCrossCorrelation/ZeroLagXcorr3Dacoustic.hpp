    ...
    namespace ZeroLagXcorr
    {
        ...
        class ZeroLagXcorr3Dacoustic : public ZeroLagXcorrSeismic<ValueType>
        {
          ...
          public:
            ...
            explicit ZeroLagXcorr3Dacoustic(scai::hmemo::ContextPtr ctx, scai::dmemo::DistributionPtr dist, KITGPI::Workflow::Workflow<ValueType> const &workflow, KITGPI::Configuration::Configuration config);
