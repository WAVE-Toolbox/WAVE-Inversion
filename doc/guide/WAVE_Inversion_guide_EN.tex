...
In WAVE-Simulation, we have introduced that \verb+useRandomSource+ can be used to apply random shot inversion. Here, we show an example of random shot inversion with \verb+useRandomSource+ = 1, \verb+NumShotDomains+ = 3 and 6 shots in total:
\begin{verbatim}
...
# Stage | Iteration | shotNumbers
    ...
    1         2        3   4   5
\end{verbatim}
If \verb+misfitType = L278+, then file \verb+misfitTypeFilename+ will be called to output the misfit type records during the random misfit inversion.
\begin{verbatim}
...
\begin{adjustbox}{width=1\textwidth,center=\textwidth}
	...
	\midrule
         ...
         seismogramTaperSTFName      & Filename-prefix of seismogram taper                                   & string & seismograms/seismoTaper \\
	\bottomrule
	\end{tabular}
	\end{adjustbox}
\end{table}
