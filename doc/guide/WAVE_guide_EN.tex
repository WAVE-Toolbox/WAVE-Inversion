...
IFOS++ is developed as a part of the WAVE-project (\url{http://wave-toolbox.org}) and is a Seismic Full-Wavfrom Inversion framework. 
...
As a first test, run the default example by following the commands to obtain the seismogram. You can compare the seismogram to the seismogram shown in figure.
...
\begin{adjustbox}{width=1\textwidth,center=\textwidth}
	...
	\midrule
         ...
         writeGradientPerShot     & Write gradient of each shot separately to file                      &  int   & 0 (=0) \\
