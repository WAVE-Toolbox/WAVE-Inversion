...
mpirun -np 3 ./../build/bin/Inversion "configuration/configuration_checkerboard_dh10cm_Surface_Stream_Elastic2D_Inv_HPC.txt" "configuration/configuration_checkerboard_dh10cm_Surface_Stream_TMEM2D_Inv_HPC.txt"
